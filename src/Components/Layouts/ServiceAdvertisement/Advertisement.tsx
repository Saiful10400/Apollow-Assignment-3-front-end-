         ...
         <CenterAlign>
            <div className="grid grid-cols-1 lg:grid-cols-10 lg:grid-rows-8 lg:h-[600px] ">
                <div className="row-span-4       col-span-4 bg-[#ff8651] p-5">
                   ...
                   <h1 className="text-xl font-medium">Happy with Look Youth & Youthful & Refreshed Nature Facility.</h1>
                </div>
                <div className="row-span-3    p-5    col-span-2 bg-[#ffe44d]">
                   
                   <h1 className="text-[100px]">14</h1>
                  <h1 className="text-xl font-medium">Branch in USA</h1>
                   </div>

                <div className="row-span-3    p-5    col-span-4 bg-[#53a5e1]">
                <div className="flex items-center gap-6"><h1 className="text-[100px]">45%</h1>
                <h1 className="text-xl font-medium">Growth In Last Year.</h1></div>
                </div>


                <div className="row-span-6    p-5    col-span-3 bg-[#d1b182]">
                <h1 className="text-3xl font-medium">Total Numbers of <br /> Customer.</h1>
                <h1 className="text-[100px]">7.9 K</h1>
                </div>
                <div className="row-span-6    p-5    col-span-3 bg-[#f95d2d]">
                <h1 className="text-3xl font-medium">Total Numbers of <br /> Review.</h1>
                <h1 className="text-[100px]">2.6 K</h1>
                </div>
                <div className="row-span-8    p-5    col-span-4 bg-[#fffbe2]">
                    <div className="flex justify-start mb-6 gap-5">
                        <img src={user1} className="w-[50px] object-cover h-[50px] rounded-full" alt="" />
                        <img src={user2} className="w-[50px] object-cover h-[50px] rounded-full" alt="" />
