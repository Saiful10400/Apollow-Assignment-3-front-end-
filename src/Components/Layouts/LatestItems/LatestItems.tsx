      ...
      <CenterAlign>
        <div>
          {data?.datya?.length === 0 ? (
            ...
            <div className="to-center mt-5 mb-8 "><NavLink to="/products" className="text-white bg-black p-3 rounded-3xl flex items-center gap-3"><span className="text-xl font-semibold">See more</span> <HiArrowLongRight className="text-4xl" /></NavLink></div>
            </>
          )}
        </div>
      </CenterAlign>
